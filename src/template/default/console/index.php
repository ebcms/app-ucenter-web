...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom shadow-sm" style="z-index:2;">
        <div class="container-fluid">
            <a class="navbar-brand wb" href="{:$router->buildUrl('/ebcms/ucenter-web/console/index')}">会员中心</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{:$router->buildUrl('/ebcms/ucenter-web/auth/logout')}">退出</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="main">
        ...
        <div class="right">
            <iframe src="{:$router->buildUrl('/ebcms/ucenter-web/console/home')}" id="mainiframe" name="main" style="width:100%;height:100%;overflow:auto;display:block;" frameborder="0"></iframe>
        </div>
    </div>
</body>
